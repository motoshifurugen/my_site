  ...
  return (
    <section className="contact">
      ...
      <form
        ...
        method="post"
        className="space-y-8 mx-6 md:mx-auto max-w-4xl bg-white px-4 md:px-16 py-4 rounded-lg dark:bg-main-black dark:text-white mb-20"
      >
        ...
        <div>
          <label
            htmlFor="name"
            className="block text-sm md:text-md font-bold mb-4"
          >
            お名前
            <span className="ml-2 md:ml-4 px-2 py-1 bg-red-500 text-white rounded text-xs md:text-sm">
              必須
            </span>
          </label>
          <input
