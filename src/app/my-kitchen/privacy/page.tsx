    ...
    <main className="max-w-2xl mx-auto py-12 px-4">
      ...
      <section className="space-y-4 text-base leading-relaxed">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li>
            ユーザーが入力する情報：料理名、メモ、カテゴリ補助選択、その他ユーザーが本アプリ内で入力する内容
          </li>
          <li>
            画像/写真（任意）：ユーザーが記録に添付する写真（端末のカメラ/フォトライブラリ機能を利用する場合）
          </li>
          <li>
            通知に関する情報（任意）：通知許可の状態（通知自体はOSが管理します）
          </li>
          <li>
            課金に関する情報：サブスクリプションの購入状況、レシート/取引識別子等（Apple/Googleおよび課金基盤を通じて取得されます。クレジットカード番号等は本アプリが取得しません）
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>
            料理記録・表示・図鑑登録など、本アプリの主要機能を実現するため
          </li>
          <li>
            サブスクリプション（プレミアム機能）の提供、購入状況の確認、復元対応のため
          </li>
        ...
        <p>
          本アプリでは、サブスクリプション管理のために RevenueCat
          を利用します。RevenueCat および Apple / Google
          は、購入状況の確認等のために必要な情報を取り扱います。RevenueCat
          の取り扱いについては同社のプライバシーポリシーもあわせてご確認ください。
        </p>
        <p className="mt-2">
        ...
        <p>本アプリ内の記録は、ユーザー操作により削除できます。</p>
        <p className="mt-2">
          課金の解約は、各ストア（App Store / Google
          Play）側の手続きに従ってください。
        </p>
        ...
        <p className="mt-2">連絡先：my-kitchen-support@furugen-island.com</p>
      </section>
    </main>
  )
}
