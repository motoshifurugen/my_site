  ...
  scenes: [
    {
      ...
      lines: [
        ...
        {
          speaker: '',
          text: '流れに逆らわず、速すぎず遅すぎず、決めた速度で歩く。',
        },
        {
          speaker: '',
        ...
        {
          speaker: '',
          text: 'オフィスビルが見えてきたところで、腕時計を一度だけ確認した。',
        },
...

    {
      ...
      lines: [
        ...
        {
          speaker: '',
          text: 'だが、反発はない。俺は、それ以上、何も言わなかった。',
        },
      ],
    },

    {
      ...
      lines: [
        {
          speaker: '',
          text: '午後、会議が終わったあと、数年前のプロジェクトのことを、ふと思い出す。',
        },
        {
          speaker: '',
          text: '反対意見は、なかった。\nただ、皆が慣れていないやり方だった。',
        ...
        {
          speaker: '',
          text: '新しいルールに従うこと。余計な感情を持ち込まないこと。時間をかけず、決められた手順で進めた結果、数字はきれいに出た。',
        },
        {
          speaker: '',
          text: '誰かを言い負かしたわけじゃない。社会のルールを理解して、それに順応しただけだ。',
        },
