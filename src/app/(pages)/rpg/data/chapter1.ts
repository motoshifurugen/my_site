  ...
  scenes: [
    {
      ...
      lines: [
        ...
        { speaker: '', text: '人間の行動も、ビジネスも、本質は似たようなものだ。' },
        { speaker: '', text: '正しい手順。正しい判断。正しいタイミング。' },
        { speaker: '', text: 'それを外さなければ、大きく間違うことはない。' },
        { speaker: '', text: 'オフィスビルが見えてきたところで、腕時計を確認した。' },
        { speaker: '', text: '"8:50"' },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: '', text: '青葉は、仕事が速いわけではない。むしろ遅い。要領も悪い。'},
        { speaker: '', text: 'その代わり、' },
        { speaker: '', text: '誰かがミスをすると何かと声をかけ、空気が重くなると、どうでもいい天気の話を始める。' },
        { speaker: '', text: '理屈では説明できないが、場が崩れない。理解できない、異物だ。' },
        ...
        { speaker: '', text: '中身に目を通す。\n…… …… ……\n方向性は合っている。だが、構成が無駄だらけだ。' },
        { speaker: '赤羽', text: '「……ここ、先にテンプレートを使えば十分で、もっと早いな」' },
    ...
    },
    {
      ...
      lines: [
        { speaker: '', text: '午後の会議が終わったあと、ふと数年前のプロジェクトのことを思い出した。' },
        { speaker: '', text: '反対意見はなかった。' },
        { speaker: '', text: 'ただ、皆が慣れていないやり方だった。' },
        { speaker: '', text: '新しいルールに従うこと。余計な感情を持ち込まないこと。' },
        { speaker: '', text: '時間をかけず、決められた手順で進めた結果、数字はきれいに出た。' },
    ...
    },
    {
      ...
      lines: [
        { speaker: '', text: '夜、同期の黄瀬燈也（きせ　とうや）といつもの居酒屋に入った。',
          characters: [
            {
              image: 'kise_1.png',
              position: 'center',
        ...
        { speaker: '', text: '予想通りの結果が得られること。それが正しい選択の証拠だ。' },
      ],
    },
  ],
}
