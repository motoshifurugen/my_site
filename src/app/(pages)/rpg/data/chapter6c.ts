  ...
  scenes: [
    {
      ...
      lines: [
        ...
        { speaker: '', text: 'マニュアル通りの答え（嘘）を吐き出すか、答えられずに無能の烙印を押されるか。' },
        { speaker: '', text: 'どちらにせよ、今の青葉には荷が重すぎる。' },
        { speaker: '', text: '俺が作り上げた「完璧な部下」という仮面が、今にも剥がれ落ちそうだ。' },
        { speaker: '', text: 'これ以上続けさせれば、彼女は決定的に傷つくか、あるいは心を殺して「完成」してしまう。' },
