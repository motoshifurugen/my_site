  ...
  scenes: [
    ...
    },
    {
      ...
      lines: [
        ...
        {
          speaker: '',
          text: 'キーボードを打つ手は、以前より格段に速くなっていた。',
          characters: [
            {
              image: 'aoba_4.png',
              position: 'center',
        ...
        {
          speaker: '',
          text: '画面を覗くと、曖昧な表現は消え、事実と数字だけが整然と並んでいる。',
          characters: [
            {
              image: 'aoba_4.png',
              position: 'center',
    ...
    },
    {
      ...
      lines: [
        {
          speaker: '',
          text: '青葉のデスク脇にあった小さな鉢植えが、いつの間にかなくなっている。',
        },
        ...
        {
          speaker: '',
          text: 'そう結論づけたはずなのに、俺の視線は、何度もその空白に戻ってしまう。',
        },
      ],
    },
    {
      ...
      lines: [
        ...
        {
          speaker: '',
          text: '青葉がまとめた資料が、スクリーンに映し出される。',
        },
        {
          speaker: '',
          text: '無駄がない。要点は明確で、リスクヘッジも完璧だ。',
        },
    ...
    },
    {
      ...
      lines: [
        ...
        {
          speaker: '',
          text: '『お疲れ様です。本日の議事録を送付します。ご確認をお願いいたします。』',
        },
        {
          speaker: '',
          text: '以前なら、ここに『今日は冷えますね』とか『会議、緊張しました』とか、ノイズのような一言があった。',
        },
        ...
        {
          speaker: '',
          text: 'ただ、静かに「正しいやり方」を提示し続け、彼女から「彼女らしさ」を奪った。',
        },
        { speaker: '', text: 'これは成長ではない。' },
        { speaker: '', text: '最適化だ。' },
        {
          speaker: '',
          text: '人間を、システムの一部として機能するように最適化した。',
        },
    ...
    },
    {
      ...
      lines: [
        ...
        {
          speaker: '赤羽',
          text: '「ああ。……ミスもしない。無駄口も叩かない。言った通りに動く。上司も褒めてたよ」',
          characters: [
            {
              image: 'kise_1.png',
              position: 'center',
        ...
        {
          speaker: '黄瀬',
          text: '「へえ、すげえじゃん。お前のコピーロボット一丁上がりってか」',
          characters: [
            {
              image: 'kise_3.png',
              position: 'center',
        ...
        {
          speaker: '',
          text: '彼女の個性を削ぎ落とし、正しさでコーティングして、俺と同じ「機能」を持たせた。',
        },
        { speaker: '', text: 'それは、成功だ。' },
        {
          speaker: '',
          text: 'だが、隣の席で馬鹿スカ笑っている黄瀬を見ていると、\n完成されたはずの自分が、ひどく欠陥品のように思えてならなかった。',
        },
      ],
    },
  ],
