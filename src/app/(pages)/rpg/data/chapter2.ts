  ...
  scenes: [
    {
      ...
      lines: [
        ...
        { speaker: "", text: "乾いた地表に降った雨で発生する揮発性物質。\n化学現象としては理解できる。"},
        ...
        { speaker: "", text: "俺は、その様子を一歩引いた位置から眺めながら、時間と進捗を頭の中で並べていた。" },
        { speaker: "", text: "和む。" },
        { speaker: "", text: "だが、業務は進まない。その事実だけが、静かに残る。" },
      ],
    },
    {
      ...
      lines: [
        { speaker: "", text: "午後、青葉がまとめた資料を確認する。\n内容は間違っていない。だが、構成が独自すぎる。" },
        { speaker: "赤羽", text: "「ここ、フォーマット使えばもっと早い」" },
        { speaker: "赤羽", text: "「先方もその形式に慣れてる。確認も早くなる」" },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: "赤羽", text: "「ここ、詰まってたなら、もう少し早く相談してほしかった」" },
        { speaker: "", text: "声は荒げない。" },
        { speaker: "赤羽", text: "「一人で抱えるより、早く出したほうが、結果的にお客さんのためになる」" },
        { speaker: "", text: "青葉は、一瞬だけ言葉を探す。" },
        { speaker: "青葉", text: "「……すみません。自分でやりきった方がいいかなって」" },
    ...
    },
    {
      ...
      lines: [
        ...
        { speaker: "", text: "そう答えながら、昼のカフェテリアの光景が、頭をよぎる。" },
        { speaker: "黄瀬", text: "「でもさ」" },
        { speaker: "", text: "黄瀬は、グラスを傾けながら続ける。" },
        { speaker: "黄瀬", text: "「正しいこと言ってりゃ、全部うまくいくってわけじゃない」" },
