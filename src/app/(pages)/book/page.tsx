...
個人面談の後、退職とカナダ渡航を決断した。`,
      bookmark: {
        title: 'この頃によく考え事をしてた場所',
        content: `【住宅街を抜ける散歩道】
朝・昼・晩歩いていた。4畳の部屋からの非難だった。`,
      },
    },
    {
...
カナダ渡航には英語が必要。
古堅の英語力はミジンコ未満だが、そのくらいが挑戦にはちょうど良い。
4ヶ月のフィリピン語学留学を決めた。`,
      bookmark: {
        title: 'この頃よく使っていたアプリ',
        content: `【ChatGPT】
...
リスニングの練習にはならなかった。おしゃれ。`,
    ...
    },
    {
      ...
      content: `少しずつできるようになってきた時が、一番美味しい。
留学生活は2ヶ月が経過。
...
多分これからも、こんな感じで生きていく。`,
      bookmark: {
        title: 'この頃に無性に食べたくなった味',
        content: `【横浜家系ラーメン】
満足感120％で忘れらんねぇよ。チャーシューは抜きで。`,
      },
    },
    {
      title: '終わりに',
