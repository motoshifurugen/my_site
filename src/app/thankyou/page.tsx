...
const ThankYou = () => {
  return (
    <section className="thank-you">
      ...
      <h1 className="text-3xl font-bold my-10 text-center">お問い合わせありがとうございます</h1>
      <p className="mt-4 text-center">お問い合わせ内容を確認させていただきますので、しばらくお待ちください。</p>
      <div className="flex justify-center">
        <a href={`${BASE_PATH}/`} className="group mt-4 text-center">
          トップページに戻る
          <button
