  ...
  return (
    <section className="thank-you">
      <div className="mx-4 md:mx-auto">
        ...
        <h1 className="text-lg md:text-3xl font-bold my-10 text-center">お問い合わせありがとうございます</h1>
        <p className="mt-4 text-center text-sm md:text-base">お問い合わせ内容を確認させていただきますので、<br />しばらくお待ちください。</p>
