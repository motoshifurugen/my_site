  ...
  return (
    <div
      ...
      style={
        !isDarkMode
          ? {
              background:
                'linear-gradient(135deg, #ffffff 0%, #f8fafc 30%, #f1f5f9 70%, #e2e8f0 100%)',
              boxShadow:
                '0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04), inset 0 1px 0 rgba(255, 255, 255, 0.6)',
            }
          : {}
      }
      onClick={handleClick}
    >
      ...
      <div className="mt-auto">
        ...
        {/* 日付とサイト名 */}
        <div
          className="text-center text-xs sm:text-xs lg:text-xs text-gray-400 dark:text-slate-300 font-light opacity-60"
          style={{ fontSize: '10px' }}
        >
