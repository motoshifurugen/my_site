  ...
  return (
    <div className="relative rounded overflow-hidden p-3 md:p-5 mb-8">
      ...
      <div className="py-2 md:py-4 my-2">
        <div className="noto-sans-jp font-bold text-lg md:text-xl mb-2">{title}</div>
      ...
      <div className="absolute bottom-0 right-0 bg-white bg-opacity-75 text-sm px-4 py-1">{date}</div>
    </div>
  );
};
