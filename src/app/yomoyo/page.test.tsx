...
// LP は言語切替え（useI18n）に対応したため、描画には I18nProvider が必要。
// i18n は next/link や CSS に依存しないため、resolve フックの登録前に静的 import しても安全。
...
// LP は client 側で言語を切り替えるため、I18nProvider 配下で描画する。
// デフォルト locale は 'ja' のため、以下の日本語アサーションはそのまま成立する。
