---
title: 'Next.jsで開発ブログ付きのポートフォリオサイトを作成したい 🚀'
date: '2024-10-27'
tags:
  - 'React'
  - 'JavaScript'
...
「Vueに比べてReactは良い」という話を聞いたため（抽象的すぎる）、Reactを使ってポートフォリオサイトを作成してみることにしました。
複数記事に分けて、作成過程を記録していきます。この記事では以下の内容を記載します。
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio01.png"
  alt="screenshot"
  width="600px"
/>
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio02.png"
  alt="screenshot"
  width="600px"
/>
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio03.png"
  alt="screenshot"
  width="600px"
/>
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio_gif01.gif"
  alt="screenshot"
  width="600px"
/>
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio04.png"
  alt="screenshot"
  width="600px"
/>
...
<img
  src="https://github.com/motoshifurugen/my_site/blob/main/img/portfolio_gif03.gif"
  alt="screenshot"
  width="600px"
/>
